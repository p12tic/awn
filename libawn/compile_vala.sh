...
#valac -C -H awn-dbus-applet.h awn-dbus-applet.vala --pkg dbus-glib-1 --pkg gtk+-2.0 --pkg posix awn-panel-connector.vapi awn-defines.vapi --pkg desktop-agnostic
sed -i -r 's/^#include <(awn.+h)>$/#include "\1"/' awn-applet.h awn-panel-connector.h #awn-dbus-applet.h
