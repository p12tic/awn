/* task-manager-api.vapi generated by vapigen, do not modify. */
...
namespace Task {
	...
	public class Manager : Awn.Applet, Gtk.Buildable, Atk.Implementor, Awn.PanelConnector {
		...
		public unowned GLib.SList get_icons_by_desktop (string desktop);
		public unowned GLib.SList get_icons_by_pid (int pid);
		public unowned GLib.SList get_icons_by_wmclass (string name);
