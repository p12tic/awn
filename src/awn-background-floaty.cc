...
#define MIN_SIDE_PADDING 6
    ...
    if (side_padding < MIN_SIDE_PADDING) {
    ...
    case GTK_POS_BOTTOM:
        ...
        *padding_bottom = bg->floaty_offset;
        *padding_left = side_padding;
        *padding_right = side_padding;
        break;
    case GTK_POS_LEFT:
        *padding_top  = side_padding;
        *padding_bottom = side_padding;
        *padding_left = bg->floaty_offset;
    ...
    case GTK_POS_RIGHT:
        ...
        *padding_right = bg->floaty_offset;
        break;
    default:
        break;
    }
